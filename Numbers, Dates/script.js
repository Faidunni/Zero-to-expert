...
console.log(
  'US:   ',
  new Intl.NumberFormat('en-US', optionProperty).format(number)
);
console.log(
  'Germany:   ',
  new Intl.NumberFormat('de-DE', optionProperty).format(number)
);
console.log(
  navigator.language,
  new Intl.NumberFormat(navigator.language, optionProperty).format(number)
);
...
setTimeout(
  (ing1, ing2) => console.log(`Here is your pizza waith ${ing1} and ${ing2}`),
  5000,
  'olives',
  'spinach'
);
